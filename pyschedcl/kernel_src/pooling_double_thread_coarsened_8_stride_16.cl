...
kernel void forwardNaive(const int batchSize, global const float *input, global int *selectors, global float *output) 
{
    ...
    const int globalId0 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/16)*16*8 +get_local_id(0)%16+0*16;

    const int globalId1 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/16)*16*8 +get_local_id(0)%16+1*16;

    const int globalId2 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/16)*16*8 +get_local_id(0)%16+2*16;

    const int globalId3 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/16)*16*8 +get_local_id(0)%16+3*16;

    const int globalId4 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/16)*16*8 +get_local_id(0)%16+4*16;

    const int globalId5 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/16)*16*8 +get_local_id(0)%16+5*16;

    const int globalId6 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/16)*16*8 +get_local_id(0)%16+6*16;

    const int globalId7 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/16)*16*8 +get_local_id(0)%16+7*16;
