...
kernel void forwardNaive(const int batchSize, global const float *input, global int *selectors, global float *output) 
{
    ...
    const int globalId0 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/32)*32*8 +get_local_id(0)%32+0*32;

    const int globalId1 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/32)*32*8 +get_local_id(0)%32+1*32;

    const int globalId2 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/32)*32*8 +get_local_id(0)%32+2*32;

    const int globalId3 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/32)*32*8 +get_local_id(0)%32+3*32;

    const int globalId4 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/32)*32*8 +get_local_id(0)%32+4*32;

    const int globalId5 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/32)*32*8 +get_local_id(0)%32+5*32;

    const int globalId6 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/32)*32*8 +get_local_id(0)%32+6*32;

    const int globalId7 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/32)*32*8 +get_local_id(0)%32+7*32;
