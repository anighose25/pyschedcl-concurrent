...
kernel void forwardNaive(const int batchSize, global const float *input, global int *selectors, global float *output) 
{
    ...
    const int globalId0 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/128)*128*4 +get_local_id(0)%128+0*128;

    const int globalId1 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/128)*128*4 +get_local_id(0)%128+1*128;

    const int globalId2 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/128)*128*4 +get_local_id(0)%128+2*128;

    const int globalId3 = get_group_id(0)*get_local_size(0)+(get_local_id(0)/128)*128*4 +get_local_id(0)%128+3*128;
